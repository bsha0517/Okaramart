...
- **Map location picker** (`components/MapLocationPicker.tsx`): customers
  can drop a pin or use their current location at checkout, using
  OpenStreetMap/Leaflet — no Google Maps API key or billing needed.
